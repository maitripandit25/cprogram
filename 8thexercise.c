/* write a program to accpet birth date and month from user.
decide zodiac sign.
steps
 1. create variable date and month.
 2. accpet variable from user. and store it in that variable
 3. use if if else and else for zodiac teble.
*/
#include<stdio.h>
void main()
{
